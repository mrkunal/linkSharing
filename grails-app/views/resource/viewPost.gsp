...
<div class="container" style="border:thin; width: 100%">
    ...
    <div class="panel panel-default" style="width:40%;float: left;margin-top: 5%">
    ...
    <p style="float:right">      <gt:exactTime time="${resource.lastUpdated}"/>
           </p><br/>
...
<p style="float: right;">
         ...
         <br/><br/><p style="float: right;margin-right: 40px"> <span id="rating"> ${ratings}</span> Ratings (
